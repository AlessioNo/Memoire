"""
Petits utilitaires partages par journal.py et rapports.py.
...
separation config.py / fenetres.py / journal.py / rapports.py : une seule version de chaque
bout de logique, reutilisee partout ou elle sert).
"""
